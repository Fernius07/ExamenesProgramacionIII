...
public class Ascensores extends JFrame {
	...
	public Ascensores() {
		...
		btnIniciar.addActionListener(e -> {			
			...
			// TAREA 3 - Hilos: Introduce aquí el código para iniciar la simulación
	...
	private JPanel crearPanelAscensor(int num) {
		...
		// Panel del botón de control del ascensor
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> new Ascensores());
	}
}